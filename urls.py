...
from user.views import adduser, index, userinfo, addstate, addcity, userinfo, stateinfo, cityinfo, updateuser, deleteuser
...
urlpatterns = [
    ...
    path('updateuser.html/<int:user_id>/', updateuser),
    path('deleteuser.html/<int:user_id>/', deleteuser)
]
